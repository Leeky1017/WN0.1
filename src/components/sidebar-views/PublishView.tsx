      ...
      <div className="flex-1 overflow-y-auto">
        {platforms.map((platform) => (
          ...
          >
            <div className="flex items-start justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-[var(--text-tertiary)]">{platform.status}</div>
                </div>
              </div>
              <button className="w-6 h-6 flex items-center justify-center rounded-md hover:bg-[var(--bg-active)] text-[var(--text-tertiary)] transition-colors">
            ...
            {!platform.connected && (
              <button className="w-full mt-2 h-6 px-2 bg-[var(--accent-primary)] hover:bg-[var(--accent-hover)] rounded-md text-[11px] text-white transition-colors">
                连接平台
              </button>
            )}
          </div>
