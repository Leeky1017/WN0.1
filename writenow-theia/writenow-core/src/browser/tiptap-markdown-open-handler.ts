...
/**
 * Why: `.md` must open in TipTap. We give it a higher priority than the default editor opener
 * so File Explorer opens Markdown with this widget without requiring preference configuration.
 */
@injectable()
