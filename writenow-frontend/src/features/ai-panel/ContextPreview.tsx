...
import { ChevronDown, ChevronRight, Eye, EyeOff, RefreshCw, Brain, Info } from 'lucide-react';
    ...
    <div className="border-b border-[var(--border-subtle)]">
      ...
      >
        ...
        <div className="flex items-center gap-1">
          {!injectionEnabled && (
            <span className="text-[10px] text-[var(--warning)]">已禁用</span>
          )}
