          ...
          <div className="space-y-2">
            {[
              ...
              <div key={data.month} className="flex items-center gap-3">
                <span className="text-[11px] text-[var(--text-tertiary)] w-8">
                  {data.month}
                </span>
                ...
                <span className="text-[11px] text-[var(--text-secondary)] tabular-nums w-16 text-right">
                  {data.count.toLocaleString()}
                </span>
                <span className="text-[10px] text-green-500 w-10 text-right">
                  {data.trend}
                </span>
              </div>
            ))}
