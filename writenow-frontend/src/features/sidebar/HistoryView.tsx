  ...
  return (
    <>
          ...
          <div className="py-2">
            ...
            <div className="space-y-1">
              {mockVersions.map((version, index) => (
                <div
                  key={version.id}
                  className={`group px-3 py-2 hover:bg-[var(--bg-hover)] cursor-pointer transition-colors duration-[100ms] ${
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {index === 0 && (
                          <span className="text-[9px] px-1.5 py-0.5 rounded bg-[var(--accent-default)] text-[var(--fg-on-accent)]">
                            当前
                          </span>
                        )}
                      </div>
      ...
      <div className="shrink-0 px-3 py-2 border-t border-[var(--border-subtle)]">
        <div className="text-[10px] text-[var(--fg-subtle)] leading-relaxed">
          <span className="inline-block w-2 h-2 rounded-full bg-[var(--accent-default)] mr-1 align-middle" />
          手动保存
          <span className="inline-block w-2 h-2 rounded-full bg-[var(--fg-subtle)] ml-3 mr-1 align-middle" />
          自动保存
        </div>
      </div>
    </>
